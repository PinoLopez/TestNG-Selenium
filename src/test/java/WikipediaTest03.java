...
public class WikipediaTest03 
{
    ...
    @Test
    public void testHighlightElementsOnMontargilPage() throws InterruptedException 
    {
        driver.get("https://en.wikipedia.org/wiki/Montargil");

        List<String> elementos = Arrays.asList("Portugal", "Ponte de Sor");
        ...
        Assert.assertTrue(title.contains("Montargil"));
