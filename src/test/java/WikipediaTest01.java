...
public class WikipediaTest01 extends BaseTest {
    ...
    public void verifyAvailableLanguages() {
        ...
        WebElement langBtn = wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.id("p-lang-btn"))
        );

        String text = langBtn.getText();

        Assert.assertTrue(
                text.matches(".*\\d+.*language.*") ||
                text.matches(".*language.*"),
    ...
    public void verifyPageHeaderTabs() {
        ...
        for (String tab : headerTabs) {
            ...
            wait.until(ExpectedConditions.visibilityOfElementLocated(
                    By.xpath("(//*[@id='p-views']//a[contains(.,'" + tab + "')] | //*[@id='p-associated-pages']//a[contains(.,'" + tab + "')])[1]")));
    ...
    public void verifyTodayFeaturedArticleExists() {
        ...
        WebElement featuredArticle = wait.until(
                ExpectedConditions.visibilityOfElementLocated(By.id("mp-tfa"))
        );
