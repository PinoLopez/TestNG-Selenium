...
public class WikipediaTest10 
{
    ...
    @Test
    public void testHighlightElementsOnAndalusiaPage() throws InterruptedException 
    {
        driver.get("https://en.wikipedia.org/wiki/Andalusia");

        List<String> elementos = Arrays.asList("Spain", "Seville");
        ...
        Assert.assertTrue(title.contains("Andalusia"));
