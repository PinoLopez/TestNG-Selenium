...
public class WikipediaTest07 {
    ...
    @Test
    public void testHighlightElementsOnAsturiasPage() throws InterruptedException {
        driver.get("https://en.wikipedia.org/wiki/Asturias");

        List<String> elementos = Arrays.asList("Spain", "Oviedo");
        ...
        Assert.assertTrue(title.contains("Asturias"));
